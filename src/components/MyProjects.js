      ...
      <div className="w-full h-auto flex flex-col mt-8 justify-center">
        <div className="w-full flex flex-col md:flex-row">
          <div className="w-full md:w-3/6 flex flex-col bg-white p-6 rounded">
            ...
            <p className="mt-3 text-sm">
              The main purpose of this project was to learn and brush up NextJS. In this project, I
              also learnt and used the Tailwind CSS. Its a great utility post css tool that helps
              write easy css utility classes. It was great fun to build this project.
            </p>
        ...
        <div className="w-full flex flex-col md:flex-row mt-16">
          <div className="w-full md:w-3/6 flex flex-col bg-white p-6 rounded">
            ...
            <p className="mt-3 text-sm">
              In this project, I did the frontend part. I made first design on Adobe XD. And then I
              built this from scratch using ReactJS, TailwindCSS and needed NPM Modules. It was fun
              to work on this project. This website's main purpose was to allow user to write code
              in any language and test it with different test cases and see the output.
            </p>
            <div className="flex space-x-3 mt-4">
              <button className="px-2 py-1 bg-custom-light-blue text-white rounded-sm">
                Live Demo
